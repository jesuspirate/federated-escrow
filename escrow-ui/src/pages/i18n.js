...
const translations = {
  ...
  en: {
    ...
    mkPlatformFee: "Platform fee",
    mkTradeTermsHidden: "Trade terms visible after purchase",
    mkHowManyTrades: "How many trades will you accept?",
  ...
  fr: {
    ...
    mkPlatformFee: "Frais de plateforme",
    mkTradeTermsHidden: "Conditions visibles après achat",
    mkHowManyTrades: "Combien d'échanges acceptez-vous ?",
    mkSellSatsBtn: "+ Vendre Sats",
    mkOfferLoanBtn: "+ Offrir un prêt",
    mkListItemBtn: "+ Publier",
  },
  ...
  es: {
    ...
    mkPlatformFee: "Tarifa de plataforma",
    mkTradeTermsHidden: "Condiciones visibles después de comprar",
    mkHowManyTrades: "¿Cuántos intercambios aceptarás?",
    mkSellSatsBtn: "+ Vender Sats",
    mkOfferLoanBtn: "+ Ofrecer préstamo",
    mkListItemBtn: "+ Publicar",
  },
  ...
  sw: {
    ...
    mkBillPay: "Lipa bili",
    mkSellSats: "Uza Sats",
    mkOfferLoan: "Toa mkopo",
    mkListItem: "Chapisha",
    mkBillAmount: "Kiasi cha bili",
    mkBaseAmount: "Kiasi cha msingi",
    mkVolunteerReceives: "Mhisani anapata",
    mkTotal: "Jumla",
    mkVolunteerEarns: "Mhisani anapata",
    mkActive: "Hai",
    mkDone: "Imekamilika",
    mkClosed: "Imefungwa",
    mkInProgress: "Inaendelea",
    mkSearchOrders: "Tafuta…",
    mkPrepare: "Andaa",
    mkViewTrade: "Angalia biashara",
    mkLockSats: "Funga Sats",
    mkLockPayment: "Funga malipo",
    mkLockEcash: "Funga E-cash",
    mkAcceptedPayment: "Njia za malipo zinazokubaliwa",
    mkFaqHow: "FAQ — Jinsi inavyofanya kazi",
    mkBecomeArbiter: "Kuwa Mwamuzi",
    mkSupportChat: "Msaada",
    mkYoureReady: "Uko tayari!",
    mkWalletReady: "Mkoba wako uko tayari. Jumuiya yako imeunganishwa.",
    mkNeedHelp: "Unahitaji msaada? Tuko hapa",
    mkPlatformFee: "Ada ya jukwaa",
    mkTradeTermsHidden: "Masharti yanaonekana baada ya kununua",
    mkHowManyTrades: "Utakubali biashara ngapi?",
    mkSellSatsBtn: "+ Uza Sats",
    mkOfferLoanBtn: "+ Toa mkopo",
    mkListItemBtn: "+ Chapisha",
  },
};
